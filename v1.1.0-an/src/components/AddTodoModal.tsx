...
import type { TodoType, CycleType } from '@hengsch/shared-types';
...
export function AddTodoModal({ isOpen, onClose }: AddTodoModalProps): React.ReactElement {
    ...
    <Modal visible={isOpen} animationType="slide" presentationStyle="pageSheet" onRequestClose={handleClose}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>添加待办</Text>
